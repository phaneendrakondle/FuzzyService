...
// Dependency management to override Spring Framework version
configurations.all {
    resolutionStrategy.eachDependency {
        if (requested.group == "org.springframework" && requested.name.startsWith("spring-")) {
            useVersion("5.3.38")
            because("CVE-2016-1000027: Fix unsafe Java deserialization vulnerability")
        }
    }
}
...
dependencies {
    ...
    implementation ("org.springframework.boot:spring-boot-starter-web:2.7.18") // Updated to resolve CVE-2016-1000027
